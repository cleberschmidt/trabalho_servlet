        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (requestCookies != null) {
                ...
                for (Cookie c : requestCookies) {
                    ...
                    out.write("<form action=\"ExcluirCookie\" method=\"post\" style=\"display:inline\">");
                    out.write("Name=" + c.getName() + ", Value=" + c.getValue());
                    out.write("<input type=\"text\" name=\"nome\"  value=\""+c.getName()+"\"  hidden />");
                    out.write("<input type=\"text\" name=\"valor\" value=\""+c.getValue()+"\" hidden />");
                    out.write("<input type=\"submit\" value=\"Excluir\"/>");
                    out.write("</form>");
                    
                    out.write("<form action=\"AlterarCookie\" method=\"post\" style=\"display:inline\">");
                    out.write("<input type=\"text\" name=\"nome\"  value=\""+c.getName()+"\"  hidden />");
                    out.write("<input type=\"text\" name=\"valor\" value=\""+c.getValue()+"\" hidden />");
